    ...
    <section className="bg-gray-50 pt-2 pb-6 md:pb-8 lg:pb-6 mb-6 md:mb-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-5 gap-8 md:gap-16 lg:gap-24 items-center lg:items-end">
        ...
        <div className="flex justify-start items-end relative lg:col-span-2 lg:self-end">
          ...
          <div className="absolute inset-0 -z-10">
            ...
            <div
              ...
              style={{
                backgroundImage:
                  "linear-gradient(135deg, rgba(219,234,254,0.9), rgba(238,242,255,0.8), rgba(243,232,255,0.9))",
              }}
            />
            {/* Secondary gradient */}
            <div
              ...
              style={{
                backgroundImage:
                  "linear-gradient(315deg, rgba(239,246,255,0.9), rgba(236,254,255,0.8), rgba(255,255,255,0))",
              }}
            />
            {/* Decorative shapes */}
            ...
            <div
              ...
              style={{
                backgroundImage:
                  "linear-gradient(135deg, rgba(96,165,250,0.2), rgba(129,140,248,0.2))",
              }}
            />
          ...
          <div
            className="relative w-full overflow-visible -ml-4 md:-ml-8 lg:-ml-12 mb-6 md:mb-10 lg:mb-12"
          ...
          >
            ...
            <div
              ...
              style={{
                backgroundImage:
                  "linear-gradient(135deg, rgba(96,165,250,0.08), rgba(129,140,248,0.08), rgba(168,85,247,0.08))",
              }}
            />
            ...
            <div
              ...
              style={{
                backgroundImage:
                  "linear-gradient(to top, rgba(30,64,175,0.3), rgba(30,64,175,0.7), rgba(255,255,255,0))",
              }}
            />
            <Image
        ...
        <div className="flex flex-col space-y-3 md:space-y-4 lg:pl-8 lg:col-span-3 lg:self-end ml-4 md:ml-0">
          <h2
            className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold leading-tight text-gray-900"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 mt-auto">
            {cards.map((card, index) => (
              <div
                ...
                className={`relative bg-white rounded-xl md:rounded-2xl p-4 md:p-6 shadow-lg border hover:shadow-xl transition-shadow overflow-visible ${index % 2 === 0 ? "mr-4 md:mr-6" : ""}`}
              >
